...
#' @param replace_regex Characters used to split \code{label_var} into terms
...
#' \code{return_all_results=TRUE}, a list with the object and intermediate
#' results.
#' @export
#' @examples
#' data("pseudo_seurat")
...
run_tfidf <- function(obj = NULL,
    ...
    obs2 <- merge(
        ...
        y = tfidf_df |>
            ...
            dplyr::summarise(
                enriched_words = paste(unique(word), collapse = "; "),
